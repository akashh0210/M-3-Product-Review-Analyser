...
def get_creds():
    ...
    # 1. Load from Environment Variable (for Render/HF)
    ...
    if not creds or not creds.valid:
        if creds and creds.expired and creds.refresh_token:
            ...
            if os.environ.get("RENDER") or os.environ.get("HF_SPACE"):
        ...
        if not os.environ.get("RENDER") and not os.environ.get("HF_SPACE"):
